...
(function() {
  ...
  */
  ...
  QuasiMovement.Polygon_Collider.prototype.initialize = function(w, h, ox, oy, shift_y) {
    Alias_QuasiMovement_Polygon_Collider_initialize.call(this, w, h, ox, oy, shift_y)
    this.depth = 0;
    this.depthHeight = 0;
    //this.depthHeight = h;
  };
